document.addEventListener("DOMContentLoaded", () => {
  ...
  // attempt1
  // const sfPlaces = document.getElementsByClassName("list-container");
  // const container = document.getElementsByClassName("list-container");
  //   event.preventDefault();

  //   const res = document.getElementsByClassName("favorite-input")
  //   const inp = res.value;
  ...
  if(photoFormDiv.className==="photo-form-container"){photoFormDiv.className="photo-form-container hidden";
