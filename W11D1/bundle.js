...
/* harmony import */ var _util_api_util_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../util/api_util.js */ "./util/api_util.js");
...
/* harmony import */ var _components_root_jsx__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/root.jsx */ "./components/root.jsx");
...
var fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  return $.ajax({
    method: 'GET',
    url: "http://api.giphy.com/v1/gifs/search?q=".concat(searchTerm, "&api_key=wnqLGRP8D62eKo3gbwliFalsjbS3ggLZ&limit=2")
  });
